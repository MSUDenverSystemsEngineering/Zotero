...
Try {
	...
	[string]$appVendor = 'Roy Rosenzweig Center for History and New Media'
	[string]$appName = 'Zotero'
	[string]$appVersion = '6.0.15'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.1'
	[string]$appScriptDate = '10/10/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-Process -Path "$dirFiles\Zotero-6.0.15_setup\setup.exe" -Parameters "/silent" -WindowStyle "Hidden" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'zotero' -CloseAppsCountdown 60
		...
		$exitCode = Execute-Process -Path "${env:ProgramFiles(x86)}\Zotero\uninstall\helper.exe" -Parameters "/silent" -WindowStyle "Hidden" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU0LKcmDh7XJ2wOweD8sat4oLL
# /4OgghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFIvG29CkOXMl2m6bfmH1gD2ZaG2DMA0GCSqGSIb3DQEBAQUABIIBgIWIeMJ3
# Qc0tV3G+OIYTGLiVWWO/7nA5/Ybyksm0E2I6L1kIJA7Bu2aUdwPFKgBWLNE543/n
# g95pzT2pdFXReXjO1HHzXTvNEpKIAKD0Nh516LB3iNLZ/ArglcY0i/9hTHT8vM40
# 2p0fTYDx8UmPMWeZ/iYV7D37tvkA3d/q6Fg2xc3wJsw9mM1SCFXQi61zQ4hTWI/d
# Qm0jmxX2eKIsH1EZdS8s0oG7RYsI5wo31rL3eeM/8SSGXOKURNO3Dpg1gLuY4Z2q
# UYkyiL0f1d5g0Cvjy40+SvT0OHJ9mYTUqvOQpqd5TkyNn1+60P8kYG/AuGA+6tkn
# A5AQEVbX/CHfFyS6YgQC+3jyJ9qn9EcM4ZLRRDuzlQSbqCwzckhWEBj1AO9Jjde2
# 37jIoUKDGTbZEuZNdPkWsi+k4GbqMerNtHjkbUSylF6ow0HU9wiiCDT9ZNBA5CrS
# QH7Op6IgN/D8OPdnoCs2/yBVH8Cz0TKRVpA92qsx65ImS+LRpd3PgLbrFw==
